                                        ...
                                        <div
                                            ...
                                            <div align="center" class="img-container center fixedwidth"
                                                ...
                                                <div style="font-size:1px;line-height:25px"> </div><img align="center"
                                                    ...
                                                    src="https://www.brokersconnector.com/img/email/logo.png"
                                                    style="text-decoration: none; -ms-interpolation-mode: bicubic; border: 0; height: auto; width: 100%; max-width: 120px; display: block;"
                                                    title="Image" width="120" />
                                    ...
                                    <div style="width:100% !important;">
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <div
                                                    style="font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; line-height: 1.2; font-size: 12px; color: #FFFFFF; mso-line-height-alt: 14px;">
                                                    <p
                                                        style="line-height: 1.2; text-align: center; font-size: 24px; mso-line-height-alt: 29px; margin: 0;">
                                                        <span style="font-size: 24px;">Tienes un nuevo mensaje 🎉</span>
                                                    </p>
                                                </div>
                                            </div>
                                            <!--[if mso]></td></tr></table><![endif]-->
                                            <div align="center" class="img-container center autowidth fullwidth"
                                                ...
                                                <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr style="line-height:0px"><td style="padding-right: 0px;padding-left: 0px;" align="center"><![endif]--><img
                                                    ...
                                                    src="https://www.brokersconnector.com/img/email/email.jpg"
                                    ...
                                    <div style="width:100% !important;">
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <div
                                                    style="font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; line-height: 1.5; font-size: 12px; color: #283C4B; mso-line-height-alt: 18px;">
                                                    @if ($request->property_id)
                                                    <p
                                                    style="font-size: 16px; line-height: 1.5; mso-line-height-alt: 24px; margin: 0;">
                                                    <span style="font-size: 16px;"><strong><span
                                                                style="font-size: 16px;">Hola {{$company_name}} </span></strong></span></p>
                                                <p style="line-height: 1.5; font-size: 12px; mso-line-height-alt: 24px; margin: 0;">
                                                    <span style="font-size: 12px;"><strong>Alguien se ha interesado
                                                            en tu propiedad <a
                                                                href="{{config('app.server')}}/property/info/{{$request->property_id}}"
                                                                rel="noopener"
                                                                style="text-decoration: underline; color: #0000FF;"
                                                                target="_blank">{{$request->subject}}</a> y te ha enviado un
                                                            mensaje</strong></span>
                                                </p>
                                                    @else
                                                    <p
                                                    ...
                                                    <span style="font-size: 16px;"><strong><span
                                                                style="font-size: 16px;">Hola {{$company_name}} </span></strong></span></p>
                                                <p style="line-height: 1.5; font-size: 12px; mso-line-height-alt: 24px; margin: 0;">
                                                    <span style="font-size: 12px;"><strong>Te han enviado un mensaje desde el formulario de contacto de tu página</strong></span>
                                                </p>
                                                    @endif
                                                </div>
                                            </div>
                                            ...
                                            <div
                                                style="color:#283C4B;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;line-height:1.5;padding-top:10px;padding-right:30px;padding-bottom:30px;padding-left:30px;">
                                                <div
                                                    style="font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 12px; line-height: 1.5; color: #283C4B; mso-line-height-alt: 18px;">
                                                    <p
                                                        style="font-size: 12px; line-height: 1.5; mso-line-height-alt: 18px; margin: 0;">
                                                        <strong>Nombre</strong> : {{ $request->name }}</p>
                                                    <p
                                                        style="font-size: 12px; line-height: 1.5; mso-line-height-alt: 18px; margin: 0;">
                                                        <strong>Email</strong> : {{ $request->email }}</p>
                                                    @if ($request->phone)
                                                        @if ($request->phone != "undefined")
                                                        <p
                                                            style="font-size: 12px; line-height: 1.5; mso-line-height-alt: 18px; margin: 0;">
                                                            <strong>Telefono</strong> : {{ $request->phone }}</p>                                     
                                                        @endif
                                                    @endif
                                                    ...
                                                    <p
                                                        ...
                                                         </p>
                                                    <p
                                                        style="font-size: 12px; line-height: 1.5; text-align: center; mso-line-height-alt: 18px; margin: 0;">
                                                        <strong>Mensaje</strong></p>
                                                        <hr>
                                                    <p
                                                        style="font-size: 12px; line-height: 1.5; text-align: left; mso-line-height-alt: 18px; margin: 0;">
                                                        {{$request->message}}</p>
                                                    <p
                                                        style="font-size: 12px; line-height: 1.5; text-align: left; mso-line-height-alt: 18px; margin: 0;">
                                                         </p>
...
<div style="color:#FFFFFF;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;line-height:1.2;padding-top:5px;padding-right:5px;padding-bottom:5px;padding-left:5px;">
...
<p style="font-size: 12px; line-height: 1.2; text-align: center; mso-line-height-alt: 14px; margin: 0;">Síguenos en nuestras redes sociales</p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
...
<td style="word-break: break-word; vertical-align: top; padding-bottom: 5px; padding-right: 10px; padding-left: 10px;" valign="top"><a href="https://www.facebook.com/Brokers-Connector-105828090888166" target="_blank"><img alt="Facebook" height="32" src="https://www.brokersconnector.com/img/email/facebook.png" style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: none; display: block;" title="Facebook" width="32"/></a></td>
<td style="word-break: break-word; vertical-align: top; padding-bottom: 5px; padding-right: 10px; padding-left: 10px;" valign="top"><a href="https://twitter.com/BrokersConector" target="_blank"><img alt="Twitter" height="32" src="https://www.brokersconnector.com/img/email/twitter.png" style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: none; display: block;" title="Twitter" width="32"/></a></td>
<td style="word-break: break-word; vertical-align: top; padding-bottom: 5px; padding-right: 10px; padding-left: 10px;" valign="top"><a href="https://www.instagram.com/brokersconnector" target="_blank"><img alt="Instagram" height="32" src="https://www.brokersconnector.com/img/email/instagram.png" style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: none; display: block;" title="Instagram" width="32"/></a></td>
</tr>
</tbody>
</table>
</td>
                    ...
                    {{--  <div style="background-color:transparent;">
                        <div class="block-grid mixed-two-up"
                            ...
                            <div
                                ...
                                <div class="col num9"
                                    style="display: table-cell; vertical-align: top; min-width: 320px; max-width: 450px; width: 450px;">
                                    <div style="width:100% !important;">
                                        <!--[if (!mso)&(!IE)]><!-->
                                        <div
                                            style="border-top:0px solid transparent; border-left:0px solid transparent; border-bottom:0px solid transparent; border-right:0px solid transparent; padding-top:5px; padding-bottom:5px; padding-right: 0px; padding-left: 0px;">
                                            ...
                                            <div
                                                ...
                                                <p
                                                    style="font-size: 12px; line-height: 1.2; color: #FFFFFF; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; mso-line-height-alt: 14px; margin: 0;">
                                                    Cualquier duda por favor contactanos</p>
                                                <p
                                                    style="font-size: 12px; line-height: 1.2; color: #FFFFFF; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; mso-line-height-alt: 14px; margin: 0;">
                                                    sistemas@brokersconnector.com - Ignacio Allende 270 entre Revolución
                                                    y Serdan, col. Centro, CP: 23000 La Paz, B.C.S. México.</p>
                                            </div>
                                            <!--[if mso]></td></tr></table><![endif]-->
                                            <!--[if (!mso)&(!IE)]><!-->
                                        </div>
