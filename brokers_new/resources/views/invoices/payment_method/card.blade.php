    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="{{ url('home/invoices/'.$invoice->id.'/payment') }}" method="POST" id="payment-form">
                    @csrf
                  <div class="row">
                      <div class="col-md-12">
                    ...
                    <div class="row" align="center">
                        <div class="col-md-12">
                            ...
                            <div class="openpay">
                                <div class=""><br><img src="{{ asset('img/pay/openpay.png') }}" alt=""><img src="{{ asset('img/pay/cards1.png') }}"
                                        alt=""> </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row" align="center">
                        <div class="col-md-12">
                            ...
                            <a href="{{ url('terms-conditions') }}">Terminos y condiciones.</a>
                        </div>
                    </div>
            </div>
        </div>
