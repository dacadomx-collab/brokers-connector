        ...
        <div class="container">
          <div class="row">
            <div class="col-md-6 align-self-center">
             <img src="/images/welcome.svg" alt="suspended-account" style="max-width: 100%;">
            </div>
            <div class="col-md-6 align-self-center">
            
              <h2>Bienvenido a Bokers Connector</h2>
              <p>Nos alegra que nos hayas elegido como tu plataforma inmobiliaria, por favor completa el registro para utilizar tu cuenta, ¿Estás listo?</p>
            
            <form method="POST" action="{{ route('complete.register.process') }}">
                @csrf
                <button type="submit" class="btn green">¡Empezar!</button>
            </form>
            </div>
          </div>
        </div>
