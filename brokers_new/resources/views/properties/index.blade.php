        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div
                    ...
                    <form  autocomplete="off" action="{{route('search.properties')}}" method="get">
                        <div class="row">
                            <div class="col-md-10">
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        {{-- <input type="text" class="form-control" name="city" placeholder="Ciudad" min="0"
                                            id="city" style="width:100%;"
                                            value="@isset($old_inputs, $old_inputs['city']){{$old_inputs['city']}}@endisset"> --}}
                                ...
                                <div class="row " style="margin-top:25px;">
                                    ...
                                    <div class="col-lg-10">
                                        ...
                                        <a id="view" style="min-height:40px;"
                                            href="/properties/change-view?value={{Session::get('view') ? '0' : '1'}}"
                                            data-toggle="tooltip" title="Cambiar vista" class="btn btn-custon-four">
                                            <i style="vertical-align: middle;"
                                                class="fa {{Session::get('view') ? 'fa-th-large' : 'fa-list'}}"></i></a>
                                        @else
                                        <a id="view" style="min-height:40px;" href="{{ url('properties/change-view') }}?value=1"
                                            data-toggle="tooltip" title="Cambiar vista" class="btn btn-custon-four">
                                        ...
                                        <select class="form-control" name="order">
                                            ...
                                            <option @isset($old_inputs, $old_inputs['order']){{$old_inputs['order']==5 ? "selected" : ""}}@endisset value="5">Marcados como favorito</option>
                                            {{--  @endforeach  --}}
                                        </select>
                                    </div>
                            ...
                            <div class="col-md-2">
                                ...
                                @isset($old_inputs)
                                <a class="text-center" href="{{route('show.all.properties')}}">Limpiar campos</a>
                                @endisset
...
<div class="courses-area">
    <div class="container-fluid" style="display:block">
        ...
        <div class="row">
            ...
            @if (Session::has('view'))
                @if (Session::get('view'))
                @include('properties.utils.properties-list')
                @else
                @include('properties.utils.properties-grid')
                @endif
            @else
            @include('properties.utils.properties-grid')
            @endif
                    ...
                    $.ajax(
                        {
                            ...
                            data: { published: published, property_id: property_id, "_token": "{{ csrf_token()  }}" },
