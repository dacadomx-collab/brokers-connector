        ...
        <div class="container">
          <div class="row">
            <div class="col-md-6 align-self-center">
             <img src="/images/suspended.png" alt="suspended-account" style="max-width: 100%;">
            </div>
            <div class="col-md-6 align-self-center">
            
              <h2>El servicio ha sido suspendido por falta de pago</h2>
              <p>
                Lamentamos que no continue con BrokersConnector, si piensa que esto ha sido un error por favor contactenos al télefono <b> 612 111 73 86 </b> ó al email <a href="mailto:contacto@brokersconnector.com">contacto@brokersconnector.com</a>
              </p>
              <a href="{{ url('home/invoices') }}" class="btn green">PAGAR</a>
            </div>
          </div>
        </div>
      </main>
