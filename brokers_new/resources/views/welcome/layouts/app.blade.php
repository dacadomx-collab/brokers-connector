...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('img/logo/img-logo-brokers2.png') }}">
    ...
    <!-- Font Awesome CSS -->
    <link rel="stylesheet" href="{{ asset('welcome/css/all.css') }}">
    <!-- Flaticon CSS -->
                ...
                <div class="col-lg-12">
                    <nav class="navbar navbar-expand-lg">
                        ...
                        <div class="collapse navbar-collapse main-menu-item" id="navbarSupportedContent">
                            <ul class="navbar-nav">
                                <li class="nav-item">
                                    <a class="nav-link ancla" href="{{ $contract ? '/' : '#banner_part' }}">Inicio</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link ancla" href="{{ $contract ? '/#benefits' : '#benefits' }}">Beneficios</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link ancla" href="{{ $contract ? '/#price' : '#price' }}">Precios</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link ancla" href="{{ $contract ? '/#contact' : '#contact' }}">Contacto</a>
                                </li>
                                @guest
                                <li class="nav-item">
                                ...
                                @else
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ url('home') }}">Mi cuenta</a>
                                </li>
                                @endguest
                            </ul>
                        </div>
