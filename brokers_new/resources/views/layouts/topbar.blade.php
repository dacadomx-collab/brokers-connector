                                                            ...
                                                            <li>
                                                                <a href="#">
                                                                    ...
                                                                    <div class="notification-content">
                                                                        ...
                                                                        <p>Fecha de vencimiento: {{Carbon::parse($notification->due_date)->format('d-m-Y')}}.</p>
                                                                    </div>
                                                                </a>
                                                            </li>  
                                                            @endforeach
                                            ...
                                            <li class="nav-item">
                                                <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle">
                                                     <div class="form-inline" style="display:inline;">
                                                        ...
                                                        <img src="{{Auth::user()->foto_avatar}}" alt="" style="height:30px; width: 30px; border-radius: 8px; margin-top: -6px;"/>                                                
                                                        
                                                        <span class="admin-name">{{ucwords(Auth::user()->full_name)}}</span>
                                                        <i class="fa fa-angle-down edu-icon edu-down-arrow"></i>
                                                    </div>
                                                    </a>
                                                <ul role="menu" class="dropdown-header-top author-log dropdown-menu animated zoomIn fast">
                                                  
                                                    {{--  <li><a href="{{route('account')}}"><span class="edu-icon edu-home-admin author-log-ic"></span>Mi cuenta</a></li>  --}}
                                                    
                                                    
                                                    <li>
                                                        <a href="{{ url('home/users/showedit/'.Auth::user()->id) }}"><i class="fa fa-user" ></i><span class="edu-icon edu-user-rounded author-log-ic"></span>Mi perfil</a>
                                                    </li>
                                                    <li>
                                                    ...
                                                    {{-- <li><a href="#"><span class="edu-icon edu-settings author-log-ic"></span>Settings</a>
                                                      ...
                                                      @role('Admin')
                                                    <li>
                                                        <a style="cursor:pointer;" href="{{ route('invoices') }}">
                                ...
                                <ul class="mobile-menu-nav">
                                    ...
                                    <li><a data-toggle="collapse" data-target="#demoevent" href="#">Propiedades <span class="admin-project-icon edu-icon edu-down-arrow"></span></a>
                                        <ul id="demoevent" class="collapse dropdown-header-top">
                                            <li><a href="{{ url('properties/index') }}">Mis propiedades</a>
                                            </li>
                                            <li><a href="{{ url('properties/create') }}">Agregar propiedad</a>
                                            </li>
                                    ...
                                    <li><a data-toggle="collapse" data-target="#demopro" href="#">Contactos <span class="admin-project-icon edu-icon edu-down-arrow"></span></a>
                                        <ul id="demopro" class="collapse dropdown-header-top">
                                            <li><a href="{{ route('contact.home')}}">Ver contactos</a>
                                            </li>
                                            <li><a href="{{ route('create.contact') }}">Agregar contacto</a>
                                            </li>
                                    ...
                                    <li><a data-toggle="collapse" data-target="#demopro" href="#">Usuarios <span class="admin-project-icon edu-icon edu-down-arrow"></span></a>
                                        <ul id="demopro" class="collapse dropdown-header-top">
                                            <li><a href="{{route('users.index')}}">Ver usuarios</a>
                                            </li>
                                            <li><a href="{{route('users')}}">Agregar usuario</a>
                                            </li>
                                    ...
                                    <li><a data-toggle="collapse" data-target="#demopro" href="#">Configuración <span class="admin-project-icon edu-icon edu-down-arrow"></span></a>
                                        <ul id="demopro" class="collapse dropdown-header-top">
                                            ...
                                            <li><a href="{{route('setting.web')}}">Sitio web</a>
                                            </li>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="breadcome-list">
                            ...
                            <div class="row">
                                <div class="col-xs-6">
                                    <h4>@yield('title', Auth::user()->company->name)</h4>
