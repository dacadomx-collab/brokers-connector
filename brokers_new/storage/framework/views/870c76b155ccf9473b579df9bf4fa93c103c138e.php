...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/fancybox/3.5.7/jquery.fancybox.css?version=<?php echo e(config('app.version')); ?>" integrity="sha256-P8k8w/LewmGk29Zwz89HahX3Wda5Bm8wu2XkCC0DL9s=" crossorigin="anonymous" />
...
<?php $__env->stopPush(); ?>
<?php $__env->startSection('title', $properties_count.' propiedades encontradas'); ?>
...
<?php $__env->startSection("company_info"); ?>
...
<?php echo $__env->make('stock.includes.filter', ["url"=>route('search.stock.index'), "disMyProperties" => false, "url_clean"=>route("show.all.stock")], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<form id="form-propertys" name="form-propertys" method="get"  autocomplete="off" action="<?php echo e(route('view.email')); ?>">
    ...
    <?php if(Session::has('view-stock')): ?>
        <?php if(Session::get('view-stock')): ?>
            <?php echo $__env->make('stock.includes.stock-list', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php else: ?>
            <?php echo $__env->make('stock.includes.stock-grid', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php endif; ?>
    <?php else: ?>
        <?php echo $__env->make('stock.includes.stock-grid', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php endif; ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\brokersconnect_dev\brokers_new\resources\views/stock/index.blade.php ENDPATH**/ ?>