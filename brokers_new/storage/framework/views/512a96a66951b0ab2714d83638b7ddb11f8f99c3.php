...
<style>
    ...
    .logo {
        z-index: 1;
        background-image: url('<?php echo e($company->logo); ?>');
    }

    .cover {
        z-index: 1;
        background-image: url('<?php echo e($company->cover); ?>');
    }

    .banner {
        z-index: 1;
        background-image: url('<?php echo e($company->banner); ?>');
    }

    .team {
        z-index: 1;
        background-image: url('<?php echo e($company->team); ?>');
    }
*/
    /*
...
<?php $__env->startSection('title', 'Mi sitio web'); ?>
                        ...
                        <div class="product-tab-list tab-pane fade active in" id="information">
                            <div class="row">
                                    <div class="courses-area">
                                      ...
                                      <h3 class="text-center"><a target="_blank" href="http://<?php echo e($company->dominio); ?>"> www.<?php echo e($company->dominio); ?></a></h3>
                                      <hr style="border-style: dashed;">
                                          
                                      <?php endif; ?>
                                        <div class="container-fluid analysis-progrebar-ctn">
                                                <form action="<?php echo e(route('website.update')); ?>" method="post" id="form-control">
                                                   <input type="hidden" name="id" value="<?php echo e(Auth::user()->company->id); ?>">
                                                   <input id="main_color" type="hidden" value="<?php echo e($data ? $data->main_color : '#FF9800'); ?>" name="main_color">
                                                   <input id="title_color" type="hidden" value="<?php echo e($data ? $data->title_color : '#000'); ?>" name="title_color">
                                                    <?php echo csrf_field(); ?>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            value="<?php echo e($data ? $data->name : ''); ?>">
                                                        </div>
                                                        ...
                                                        <div class="form-group edit-ta-resize">
                                                            ...
                                                            <textarea name="about" rows="4" style="height:unset;" placeholder="Escribe acerca de tu organización"><?php echo e($company->about); ?></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-3 col-sm-6">
                                        ...
                                        <form enctype="multipart/form-data" id="formlogo" method="POST">
                                            <label id="logo" for="logo_input" class="container-image">
                                                <img src="<?php echo e($company->logo_image); ?>" alt="Avatar" class="image">
                                                <div class="overlay">
                                    ...
                                    <div class="col-md-3 col-sm-6">
                                        ...
                                        <form enctype="multipart/form-data" id="formcover" method="POST">
                                            <label id="cover" for="cover_input" class="container-image">
                                                <img src="<?php echo e($company->cover_image); ?>" alt="Avatar" class="image">
                                                <div class="overlay">
                                                    <div class="text"><i class="fa fa-upload"></i>
                                                        <p style="font-size: large;">Subir imagen</p>
                                                        <input class="imagen" style="position:absolute; opacity:0;"
                                    ...
                                    <div class="col-md-3 col-sm-6">
                                        ...
                                        <form enctype="multipart/form-data" id="formbanner" method="POST">
                                            <label id="banner" for="banner_input" class="container-image">
                                                <img src="<?php echo e($company->banner_image); ?>" alt="Avatar" class="image">
                                                <div class="overlay">
                                                        <div class="text"><i class="fa fa-upload"></i>
                                                            <p style="font-size: large;">Subir imagen</p>
                                                        <input class="imagen" style="position:absolute; opacity:0;"
                                    ...
                                    <div class="col-md-3 col-sm-6">
                                        ...
                                        <form enctype="multipart/form-data" id="formteam" method="POST">
                                            <label id="team" for="team_input" class="container-image">
                                                <img src="<?php echo e($company->team_image); ?>" alt="" class="image">
                                                <div class="overlay">
                                                        <div class="text"><i class="fa fa-upload"></i>
                                                            <p style="font-size: large;">Subir imagen</p>
                                                        <input class="imagen" style="position:absolute; opacity:0;"
...
document.getElementById('btn-cancel')
        ...
        const title = Pickr.create({
           ...
           // useAsButton: true,
           default: "<?php echo e($data ? $data->title_color : '#555'); ?>",
            swatches: [
                'rgba(244, 67, 54, 1)',
                'rgba(233, 30, 99, 0.95)',
                'rgba(156, 39, 176, 0.9)',
        ...
        const main = Pickr.create({
            ...
            theme: 'nano', // or 'monolith', or 'nano'
           // useAsButton: true,
           default: "<?php echo e($data ? $data->main_color : '#FF9800'); ?>",
            swatches: [
                'rgba(244, 67, 54, 1)',
                'rgba(233, 30, 99, 0.95)',
                'rgba(156, 39, 176, 0.9)',
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\brokersconnect_dev\brokers_new\resources\views/website/setting.blade.php ENDPATH**/ ?>