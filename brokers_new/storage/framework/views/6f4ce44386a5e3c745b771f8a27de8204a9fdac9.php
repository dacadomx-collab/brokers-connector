...
<section cid="benefits" class="feature_part padding_top">
        <div class="container">
<div class="text-center">
    <H1><strong>POLÍTICAS DE PRIVACIDAD</strong></H1>
</div>
<p>&nbsp;</p>
<div style="text-align: justify;">

    <p>El presente Política de Privacidad establece los términos en que BrokersConnector usa y protege la información que es
    ...
    <p>Nuestro sitio web emplea la información con el fin de proporcionar el mejor servicio posible, particularmente para
        ...
        cualquier momento.</p>
    <p>BrokersConnector está altamente comprometido para cumplir con el compromiso de mantener su información segura. Usamos
    ...
    <p>Nuestro sitio web emplea las cookies para poder identificar las páginas que son visitadas y su frecuencia. Esta
        ...
        menos de que usted así lo quiera y la proporcione directamente, sin embargo la mayoría de navegadores aceptan cookies automáticamente pues sirve para
    ...
    <p>BrokersConnector Se reserva el derecho de cambiar los términos de la presente Política de Privacidad en cualquier
        momento.</p>
</div>
</div>
</section>
...
<?php echo $__env->make('welcome.layouts.app' , ["contract"=> true], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\brokersconnect_dev\brokers_new\resources\views/welcome/privacy/politics.blade.php ENDPATH**/ ?>