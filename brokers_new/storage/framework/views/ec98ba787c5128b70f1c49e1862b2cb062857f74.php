<div class="row">
        <div class="form-group col-lg-6 col-md-12 col-sm-12 col-xs-12" style="margin-top: 0;">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-group">
                ...
                <input name="title" type="text" value="<?php echo e(old('title',$data->title)); ?>" maxlength="100" class="form-control"
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-group">
                ...
                <input name="title_en" type="text" value="<?php echo e(old('title',$data->title_en)); ?>" maxlength="100" class="form-control"
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 form-group" style="margin: 0px 0px 10px 0;">    
                ...
                <select name="prop_type_id" class="form-control" required style="z-index:1;">
                    ...
                    <option <?php echo e($item->id == old('prop_type_id', $property->prop_type_id) ? 'selected' : ''); ?> value="<?php echo e($item->id); ?>">
                        <?php echo e(ucwords($item->name)); ?></option>
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 form-group" style="margin: 0px 0px 10px 0;">
                ...
                <select name="prop_use_id" class="form-control" required style="z-index:1;">
                    ...
                    <?php $__currentLoopData = $uses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        
                            <option <?php echo e($item->id == old('prop_status_id', $property->prop_use_id) ? 'selected' : ''); ?> value="<?php echo e($item->id); ?>">
                                <?php echo e(ucwords($item->name)); ?></option>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-group" style="margin: 0px 0px 10px 0;">
                ...
                <select name="prop_status_id" class="form-control" required style="z-index:1;">
                    ...
                    <option <?php echo e($item->id == old('prop_status_id', $property->prop_status_id) ? 'selected' : ''); ?> value="<?php echo e($item->id); ?>">
                        <?php echo e(ucwords($item->name)); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
            <div class="form-group res-mg-t-15 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <textarea required name="description" id="description" placeholder="Ingresa una descripción breve" maxlength="1000"><?php echo e(old('description', $data->description)); ?></textarea>
            </div>

            
            <div class="form-group res-mg-t-15 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <label for="">Descripción en inglés</label> 
                <textarea name="description_en" placeholder="Ingresa una descripción breve en inglés" maxlength="1000"><?php echo e(old('description', $data->description_en)); ?></textarea>
            </div>
            ...
            <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-6" style="margin: 0px 0px 10px 0;">
                <div class="input-group" style="margin: 0px 0px 10px 0;">
                    ...
                    <input type="hidden" id="price" name="price" value="<?php echo e(old('price', $data->price)); ?>" min="0" max="9999999999" placeholder="Ingresa la cantidad"
            ...
            <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-6" style="margin: 0px 0px 10px 0;">
                <div class="form-group" style="margin: 0px 0px 10px 0;">
                    <select name="currency" class="form-control" required>
                        <option <?php echo e("" == old('currency', $data->currency) ? 'selected' : ''); ?> value="">Moneda</option>
        
                        <?php $__currentLoopData = config('app.currency'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option <?php echo e($index == old('currency', $data->currency) ? 'selected' : ''); ?> value="<?php echo e($index); ?>"><?php echo e(ucwords($item)); ?>
        ...
        <div class="form-group col-lg-6 col-md-12 col-sm-12 col-xs-12 ">
            ...
            <div class="col-md-4" style="margin-top:10px;">
                <input type="text" maxlength="5" class="form-control" name="zipcode" id="zipcode" placeholder="Codigo Postal" value="<?php echo e(old('zipcode', $data->zipcode)); ?>" required>
            </div>
            <div class="col-md-4" style="margin-top:10px;">
                <input type="text" maxlength="100" class="form-control" name="exterior" id="exterior" placeholder="Num. exterior" value="<?php echo e(old('exterior', $data->exterior)); ?>">
            </div>
            <div class="col-md-4" style="margin-top:10px;">
                <input type="text" maxlength="100" class="form-control" name="interior" id="interior" placeholder="Num. interior" value="<?php echo e(old('interior', $data->interior)); ?>">
            </div>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-top:10px;">
                ...
                <input type="text" maxlength="150" class="form-control" name="address" id="address" placeholder="Escriba las calles" value="<?php echo e(old('address', $data->address)); ?>" required>
            </div>
        </div>
        <?php if(!$edit): ?>
        ...
        <?php $__env->startPush('scripts'); ?>
            <script src="<?php echo e(asset('admin/js/select2/select2.full.min.js')); ?>"></script>
            <script src="<?php echo e(asset('admin/js/select2/select2-active.js')); ?>"></script>
            <script src="<?php echo e(asset('js/location-control.js?version=1')); ?>"></script>
            <script src="<?php echo e(asset('admin/js/input-mask/jasny-bootstrap.min.js')); ?>"></script>
            ...
            setFormatPrice("<?php echo e(old('price', $data->price)); ?>")
        ...
        <?php /**PATH C:\xampp\htdocs\brokersconnect_dev\brokers_new\resources\views/properties/utils/tab-general.blade.php ENDPATH**/ ?>