    ...
    <div class="flip-col">
        <div class="flip-card" tabIndex="0">
            <div class="flip-card-inner">
                ...
                <div class="flip-card-back">
                    <p class="text"><a href="<?php echo e(route('contact.home')); ?>">Directorio</a></p>
                </div>
            </div>
        </div>
    </div>
...
<?php /**PATH C:\xampp\htdocs\brokersconnect_dev\brokers_new\resources\views/includes/flip-cards.blade.php ENDPATH**/ ?>