    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                            ...
                            <svg version="1.1" id="cardfront" xmlns="http://www.w3.org/2000/svg"
                                ...
                                <g id="Front">
                                    ...
                                    <text transform="matrix(1 0 0 1 65.1054 241.5)" class="st7 st5 st8">card
                                        number</text>
                                    <g>
                                        <text transform="matrix(1 0 0 1 574.4219 433.8095)" id="svgexpire_mes"
                                            class="st2 st5 st9">01</text>
                                        <text transform="matrix(1 0 0 1 620.4219 433.8095)" class="st2 st5 st9">/</text>
                                        <text transform="matrix(1 0 0 1 650.4219 433.8095)" id="svgexpire_año"
                                            class="st2 st5 st9">23</text>
                ...
                <form action="<?php echo e(url('home/invoices/'.$invoice->id.'/payment')); ?>" method="POST" id="payment-form">
                    <?php echo csrf_field(); ?>
                  <div class="row">
                      <div class="col-md-12">
                        <div class="form-container">
                            <div class="field-container">
                                ...
                                <input id="name" type="text" placeholder="Como aparece en la tarjeta" maxlength="75"
                                    autocomplete="off" data-openpay-card="holder_name">
                            </div>
    
                            <div class="field-container">
                                <label for="cardnumber">Número de tarjeta</label>
                                <input id="cardnumber" placeholder="Número de tarjeta" type="text" autocomplete="off"
                            ...
                            <div class="field-container">
                                ...
                                <div class="sctn-col half l"><input id="expirationdate_mes" type="text" placeholder="Mes"
                                        data-openpay-card="expiration_month"></div>
                            </div>
                            <div class="field-container">
                                <label for="expirationdate">&nbsp;</label>
                                <div class="sctn-col half l"><input id="expirationdate_año" type="text" placeholder="Año"
                                        data-openpay-card="expiration_year"></div>
                            </div>
                            <div class="field-container">
                                <label for="securitycode">Código de seguridad</label>
    
                                <div class="sctn-col half l"><input id="securitycode" type="text" placeholder="3 dígitos"
                    ...
                    <div class="row" align="center">
                        <div class="col-md-12">
                            <div class="sctn-row">
                                <button class="btn btn-lg btn-primary" id="pay-button">Pagar</button>
                            </div>
                            <div class="openpay">
                                <div class=""><br><img src="<?php echo e(asset('img/pay/openpay.png')); ?>" alt=""><img src="<?php echo e(asset('img/pay/cards1.png')); ?>"
                                        alt=""> </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row" align="center">
                        <div class="col-md-12">
                            ...
                            <p>
                                <b>Dirección:</b> Ignacio Allende 270 entre Revolución y Serdan, col. Centro, CP: 23000
                                La Paz, Baja California Sur, México.
                            </p>
                            <p> <b>Contacto:</b> sistemas@brokersconnector.com </p>
                            <a href="<?php echo e(url('terms-conditions')); ?>">Terminos y condiciones.</a>
                        </div>
                    </div>
            </div>
        </div>
...
<?php /**PATH C:\xampp\htdocs\brokersconnect_dev\brokers_new\resources\views/invoices/payment_method/card.blade.php ENDPATH**/ ?>