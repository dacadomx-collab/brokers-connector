                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <form enctype="multipart/form-data" id="formcover" method="POST">
                        <label id="cover" for="cover_input" class="container-image">
                            <img src="<?php echo e($data->foto_avatar); ?>" alt="Avatar" id="avatar" class="image">
                            <div class="overlay">
...
</div><?php /**PATH C:\xampp\htdocs\brokersconnect_dev\brokers_new\resources\views/users/utils/modal-avatar.blade.php ENDPATH**/ ?>